...
public class ProducerWindow extends javax.swing.JFrame {
    ...
    // End of variables declaration//GEN-END:variables
     ...
     private void initHelper() {
        helper = new ProducerWindowHelper(this, type, xmlSkeleton);
    }

    private void initXMLSkeleton() {
        // Strip Message parts
        int i  = xmlSkeleton.indexOf("</header>");
        String s = xmlSkeleton.substring( i + 10);
        i = s.indexOf("</nl.hmf.core.Message>");
